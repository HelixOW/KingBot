...
import { MessageAttachment, MessageActionRow, MessageButton, CommandInteraction } from 'discord.js';
			...
			await sendMenu(
				...
				[{
					...
					onCollect: async (i, m) => {
						...
						for(let replaceFieldItem of replaceFieldArray)
							embeds.push(new DefaultEmbed("Replaced Units so far").addFields(replaceFieldItem))
						try {
