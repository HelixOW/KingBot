...
export class GameUnitData {
    ...
    private _awakening: number
    public get awakening(): number {
        return this._awakening
    }
    public set awakening(value: number) {
        this._awakening = value
    }
    
    private _superAwakening: number
    public get superAwakening(): number {
        return this._superAwakening
    }
    public set superAwakening(value: number) {
        this._superAwakening = value
    }
    ...
    public constructor(id: number, level: number, awakening: number, superAwakening: number, cc: number) {
        this.id = id
        this.level = level
        this.awakening = awakening
        this.superAwakening = superAwakening
        this.cc = cc
    }
}
